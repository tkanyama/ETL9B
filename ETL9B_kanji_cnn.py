...
hist = model.fit_generator(datagen.flow(x_train, y_train, batch_size=256), samples_per_epoch=x_train.shape[0],
                    nb_epoch=48, validation_data=(x_test, y_test))
# 学習を実行して評価 --- (*4)
...
# モデルを評価
model.save(home + '/ETL/ETL9B/etl9b_{}_model01.h5'.format(im_size))
model.save_weights(home + '/ETL/ETL9B/etl9b_{}_weight01.h5'.format(im_size))
