...
# home = expanduser("~")
# home = 'E:/DATA'
home = '/Users/kanyama/Documents/DATA/'
import time
t0 = time.time()
...
bsize = 2048
epoch_n = 50
steps_per_epoch1=int(x_train.shape[0]/bsize)
...
hist = model.fit_generator(datagen.flow(x_train, y_train, batch_size=bsize), steps_per_epoch=steps_per_epoch1,
                    epochs=epoch_n, validation_data=(x_test, y_test))
# 学習を実行して評価 --- (*4)
...
# モデルを評価
model.save(home + 'etl9b_model15-Mac_1_{}_{}_{}_03.h5'.format(im_size, bsize, epoch_n))
