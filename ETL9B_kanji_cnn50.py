...
# データファイルと画像サイズの指定
data_file = home + "/ETL/ETL9B/ETL9B_50.pickle"
...
# モデルを評価
model.save(home + '/ETL/ETL9B/etl9b_{}_model_01.h5'.format(im_size))
model.save_weights(home + '/ETL/ETL9B/etl9b_{}_weight_01.h5'.format(im_size))
