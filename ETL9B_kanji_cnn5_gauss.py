...
data_file2 = home + "/ETL/ETL9B/ETL9B_32_gaus.pickle"
...
(im_size, out_size, data1) = pickle.load(open(data_file1, "rb"))
(im_size, out_size, data2) = pickle.load(open(data_file2, "rb"))
data = np.concatenate([data1, data1], 0)
data = data.tolist()
...
# モデルを評価
model.save(home + '/ETL/ETL9B/etl9b_model5_plus_gauss_{}_{}_{}_01.h5'.format(im_size, bsize, epoch_n))
